...
//Projeto simples feito em menos de 24h por Ricardo Goetten para a seleção da empresa BemPaggo.

//Início da contrução do objeto
public class Jogo8 extends JFrame implements ActionListener{
...
super("Jogo dos 8");
 ...
 b8=new JButton("8");
 b9=new JButton("2");
 next=new JButton("embaralhar"); //botão para gerar números aleatórios

//Layout com parâmetros para os botões 
...
JOptionPane.showMessageDialog(Jogo8.this,"!!!VOCÊ VENCEU!!!"); // Mensagem de encerramento
}
 }
